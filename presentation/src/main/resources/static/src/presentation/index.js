      ...
      <Spectacle theme={theme}>
        ...
        <Deck transition={["zoom", "slide", "Fade"]} transitionDuration={500} progress={'none'}>
          ...
          <Slide transition={["zoom"]} bgColor="black">
            <Image src={images.react.replace("/", "")} margin="-80px auto 20px" height="300px"/>
            <Image src={images.bootlogo.replace("/", "")} margin="-80px auto 20px" height="300px"/>
            ...
            <Text textSize="30pt" textAlign="left" textColor="#61DAFB">Desert Code Camp 2016 #DCC16</Text>
            <hr/>
            <Text textSize="30pt" textAlign="left" textColor="#FFF">Dave Townsend</Text>
             <Text textSize="25pt" textAlign="left" textColor="#a8a8a8"><i>Principal Software Engineer - Matson, Inc</i></Text>
          ...
          <Slide transition={["slide"]}>
            <Text textSize="25pt" textAlign="left" textColor="#000" margin="-150px auto 0px">
              <b>resources</b>
          ...
          <Slide transition={["slide"]}>
            <Image src={images.webpack.replace("/", "")} margin="0px auto -10px" height="500px"/>
          </Slide>
          ...
          <Slide transition={["slide"]} bgColor="primary">
            <Image src={images.react2.replace("/", "")} height="200px"/>
          ...
          <Slide transition={["slide"]}>
            <Text textSize="30pt" textColor="#000">
          ...
          <Slide transition={["slide"]}>
            ...
            <Text textSize="50pt" textAlign="left" textColor="#000">
              custom config to tell boot<br/> we're controlling the UI
            </Text>
          </Slide>
          ...
          <Slide transition={["slide"]}>
            ...
            <Link href="https://github.com/davetownsend/dcc16" textSize="40pt" target="_blank">github.com/davetownsend/dcc16</Link>
          </Slide>
